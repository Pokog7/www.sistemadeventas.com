...
<div class="login-box">
    <!-- /.login-logo -->
        ...
        <script>
            swal({
                ...
                text: "Haz click para reintentar",
                icon: "error",
                button: "continuar",
            });
        </script>
    ...
    <center>
        ...
        <img src="../public/images/logo%20e-software.png" width="200px">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="../public/templates/AdminLTE-3.1.0/index2.html" class="h1"><b>Sistema de </b> Ventas</a>
        </div>
        <div class="card-body">
