                                    ...
                                    <div class="col-md-12">
                                        <form action="../app/controllers/usuarios/create.php" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombres" class="form-control" placeholder="Escriba aqui su Usuario" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Email</label>
                                                <input type="email" name="email" class="form-control" placeholder="Escriba aqui su Correo" required>
                                            </div>
                                            <div class="form-group">
